...
import io.sarl.csharpgenerator.generator.generator.CsharpInitializers;
 ...
 */
@Singleton
public class CsharpPreferenceInitializer implements IPreferenceStoreInitializer {
	...
	private static void initializeTypeConversion(IPreferenceStore store) {
		final IExtraLanguageConversionInitializer tcInitializer = CsharpInitializers.getTypeConverterInitializer();
	...
	private static void initializeFeatureNameConversion(IPreferenceStore store) {
		final IExtraLanguageConversionInitializer fnInitializer = CsharpInitializers.getFeatureNameConverterInitializer();
	...
	private static void initializeGeneralOptions(IPreferenceStore store) {
		...
		key = ExtraLanguagePreferenceAccess.getPrefixedKey(CsharpGeneratorPlugin.PREFERENCE_ID,
