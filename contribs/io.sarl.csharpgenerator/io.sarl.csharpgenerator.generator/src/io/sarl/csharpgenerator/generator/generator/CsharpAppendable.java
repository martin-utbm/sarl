 ...
 * @since 0.6
 */
public class CsharpAppendable extends ExtraLanguageAppendable {
	 ...
	 */
	public CsharpAppendable(JvmDeclaredType thisType, ExtraLanguageTypeConverter converter) {
