 ...
 */
public class CsharpGeneratorPlugin extends Plugin {

	/** Identifier of the plugin.
	 */
	public static final String PLUGIN_ID = "io.sarl.csharpgenerator.generator"; //$NON-NLS-1$

	/** Identifier of the preference container.
	 */
	public static final String PREFERENCE_ID = PLUGIN_ID;

	private static CsharpGeneratorPlugin instance;

	/** Construct an Eclipse plugin for SARL.
	 */
	public CsharpGeneratorPlugin() {
		setDefault(this);
	}
	 ...
	 */
	public static void setDefault(CsharpGeneratorPlugin defaultInstance) {
	 ...
	 */
	public static CsharpGeneratorPlugin getDefault() {
		return instance;
	}
