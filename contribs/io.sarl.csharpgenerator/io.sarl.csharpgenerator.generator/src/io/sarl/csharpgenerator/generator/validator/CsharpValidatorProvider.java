 ...
 */
@Singleton
public class CsharpValidatorProvider implements IExtraLanguageValidatorProvider {
	...
	public List<AbstractExtraLanguageValidator> getValidators(Resource resource) {
		final CsharpValidator validator = this.injector.getInstance(CsharpValidator.class);
