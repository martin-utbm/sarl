...
/** Provider of a configuration for the SARL-to-C# generator.
 *
 ...
 */
@Singleton
public class CsharpGeneratorConfigurationProvider implements ICsharpGeneratorConfigurationProvider {
	...
	@Override
	public CsharpGeneratorConfiguration get(Resource context, boolean installedIfNew) {
		...
		final CsharpGeneratorConfiguration config = createConfiguration(context);
	...
	protected CsharpGeneratorConfiguration createConfiguration(Resource context) {
		return new CsharpGeneratorConfiguration();
	}
	 ...
	 */
	public CsharpGeneratorConfiguration install(ResourceSet resourceSet, CsharpGeneratorConfiguration config) {
		assert config != null;
	...
	public static class PyGeneratorConfigAdapter {
		...
		private final Map<String, CsharpGeneratorConfiguration> language2GeneratorConfig = new HashMap<>();
		 ...
		 */
		@Pure
		public Map<String, CsharpGeneratorConfiguration> getLanguage2GeneratorConfig() {
