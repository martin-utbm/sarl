...
package io.sarl.csharpgenerator.generator.validator;
 ...
 */
@Singleton
public class CsharpValidator extends AbstractExtraLanguageValidator {
	 ...
	 */
	@Inject
	public CsharpValidator(CsharpKeywordProvider keywordProvider) {
	...
	protected void initializeContext(Context validatorContext) {
		...
		final CsharpGeneratorConfiguration config = this.configuration.get(resource, true);
