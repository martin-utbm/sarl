 ...
 */
@FunctionalInterface
@ImplementedBy(CsharpGeneratorConfigurationProvider.class)
public interface ICsharpGeneratorConfigurationProvider {
	 ...
	 */
	CsharpGeneratorConfiguration get(Resource context, boolean installedIfNew);
